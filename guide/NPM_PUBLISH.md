...
> @kedman1234/react-light-table@2.0.4 build
> rollup -c
...
```bash
npm notice
npm notice 📦  @kedman1234/react-light-table@2.0.4
...
npm notice filename: kedman1234-react-light-table-2.0.4.tgz
...
npm notice
kedman1234-react-light-table-2.0.4.tgz
```
...
```bash
tar -tzf kedman1234-react-light-table-2.0.4.tgz
```
...
git add .
git commit -m "feat: prepare v2.0.4 for npm publish"
git tag v2.0.4
